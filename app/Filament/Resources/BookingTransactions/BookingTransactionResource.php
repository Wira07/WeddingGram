...
use App\Filament\Resources\BookingTransactions\Pages\ViewBookingTransaction;
use App\Filament\Resources\BookingTransactions\Schemas\BookingTransactionForm;
use App\Filament\Resources\BookingTransactions\Schemas\BookingTransactionInfolist;
...
class BookingTransactionResource extends Resource
{
    ...
    {
        return BookingTransactionInfolist::configure($schema);
    }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => ViewBookingTransaction::route('/{record}'),
