...
use App\Filament\Resources\WeddingPackages\Pages\ViewWeddingPackage;
use App\Filament\Resources\WeddingPackages\Schemas\WeddingPackageForm;
use App\Filament\Resources\WeddingPackages\Schemas\WeddingPackageInfolist;
...
class WeddingPackageResource extends Resource
{
    ...
    {
        return WeddingPackageInfolist::configure($schema);
    }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => ViewWeddingPackage::route('/{record}'),
