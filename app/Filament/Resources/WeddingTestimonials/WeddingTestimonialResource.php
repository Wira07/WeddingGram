...
use App\Filament\Resources\WeddingTestimonials\Pages\ViewWeddingTestimonial;
use App\Filament\Resources\WeddingTestimonials\Schemas\WeddingTestimonialForm;
use App\Filament\Resources\WeddingTestimonials\Schemas\WeddingTestimonialInfolist;
...
class WeddingTestimonialResource extends Resource
{
    ...
    {
        return WeddingTestimonialInfolist::configure($schema);
    }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => ViewWeddingTestimonial::route('/{record}'),
